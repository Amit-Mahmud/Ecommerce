    ...
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-green order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-tag f-left"></i><span>1641</span>
                </h2>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-yellow order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-reload f-left"></i><span>42,562
                        BDT</span></h2>
                <p class="m-b-0">This Month<span class="f-right">5,032 BDT</span></p>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-pink order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-wallet f-left"></i><span>9,562
                        BDT</span></h2>
                <p class="m-b-0">This Month<span class="f-right">542 BDT</span></p>
            </div>
        </div>
    </div>
    <!-- order-card end -->
