                                            ...
                                            <li class="product-item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                <div class="contain-product layout-default">
                                                    <div class="product-thumb">
                                                        <a href="single_product.php?status=singleproduct&&id=<?php echo $pro['pdt_id'];?>"
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <h4 class="product-title"><a
                                                                href="single_product.php?status=singleproduct&&id=<?php echo $pro['pdt_id'];?>"
                                                                class="pr-name"><?php echo $pro['pdt_name']; ?></a></h4>
                                                        <div class="price">
                                                            <ins><span class="price-amount"><span
                                                                        class="currencySymbol">BDT</span><?php echo $pro['pdt_price']; ?></span></ins>
                                                        </div>
