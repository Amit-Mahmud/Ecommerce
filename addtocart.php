    ...
    if(isset($_POST['addtocart'])){
        if(isset($_SESSION['cart'])){
          ...
          if(in_array($_POST['pdt_name'], $products_name)){
              echo "
                <script> alert('This Product is already added!');
                </script>
              ";
          }else{
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-price" data-title="Price">
                                                <div class="price price-contain">
                                                    <ins><span class="price-amount"><span class="currencySymbol">BDT
                                                            </span><?php echo $value['pdt_price']; ?></span></ins>
                                                </div>
                                            </td>
                        ...
                        <td class="product-subtotal" data-title="Total">
                            <div class="price price-contain">
                                <ins><span class="price-amount"><span
                                            class="currencySymbol">BDT</span><?php echo $value['pdt_price']; ?></span></ins>
                            </div>
                        </td>
                        </tr>
                        <?php }}else{
                        ...
                        <div class="shpcart-subtotal-block">
                            <div class="subtotal-line">
                                <b class="stt-name">Subtotal <span
                                        class="sub"><?php echo $total_product.'items'; ?></span></b>
                                <span class="stt-price">BDT <?php echo  $subtotal; ?></span>
                            </div>
                            <div class="subtotal-line">
                                <b class="stt-name">Shipping</b>
                                <span class="stt-price">BDT 90.00</span>
                            </div>
                            <div class="tax-fee">
                                <p class="title">Est. Taxes & Fees</p>
                                <p class="desc">Based on Product</p>
                            </div>
